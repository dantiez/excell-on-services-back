        ...
        <div className="container mt-4">
            <div className="container my-4">
                ...
                <div className="d-flex justify-content-center mb-4">
                    <button
                        className={`btn btn-outline-primary me-2 ${filter === "paid" ? "active" : ""
                            }`}
                        onClick={() => {
                            setFilter("paid");
                            setCurrentPage(1);
                    ...
                    <button
                        className={`btn btn-outline-primary ${filter === "not_yet_paid" ? "active" : ""
                            }`}
                        onClick={() => {
                                    ...
                                    return (
                                        <React.Fragment key={key}>
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        className={`badge ${filter === "not_yet_paid"
                                                                ? "bg-danger"
                                                                : "bg-success"
                                                            }`}
                                                    >
