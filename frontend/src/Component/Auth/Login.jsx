...
export const Login = () => {
  ...
  const { setAccessToken, setRefreshToken, setUserData } = getActions();
  const onSubmit = async (data) => {
    ...
    const userData = await UserService.getUserById(loginData.userId);

    if (!!userData.error) {
      toast.error(`Login Failed ${userData?.error}`);
      return;
    }
